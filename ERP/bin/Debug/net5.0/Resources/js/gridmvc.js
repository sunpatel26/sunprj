    ...
    */
    ...
    gridMvc.prototype.getFilterQueryData = function (columnName, values) {
        ...
        for (var i = 0; i < values.length; i++) {
            url += "grid-filter=" + encodeURIComponent(columnName) + "_" + values[i].filterType + "_" + encodeURIComponent(values[i].filterValue);
    ...
    */
    ...
    gridMvc.prototype.getExtSortQueryData = function (column, sorted, pos) {
        ...
        if (column && column !== "undefined") {
            url += "grid-sorting=" + encodeURIComponent(column) + "_" + sorted + "_" + pos;
        }
        return url;
    };
