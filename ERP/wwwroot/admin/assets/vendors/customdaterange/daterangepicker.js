(function () {
    ...
    u = function () {
        ...
        return e.prototype.extend = function (t) {
            var e, n, a;
            n = [];
            for (e in this) a = this[e], this.hasOwnProperty(e) && "_" !== e[0] && n.push(t[e] = a);
            return n
        ...
        return t.prototype.calendar = function () {
            ...
            }, r[this.type + "-date"] = i, r.clickable = o, r["out-of-boundaries"] = !o, r.unavailable = e && n, r
        ...
        function t(t) {
            var e, n, i, o;
            null == t && (t = {}), this.outsideClick = p(this.outsideClick, this), this.setDateRange = p(this.setDateRange, this), new r(t).extend(this), this.startCalendar = new a(this, this.startDate, "start"), this.endCalendar = new a(this, this.endDate, "end"), this.startDateInput = this.startCalendar.inputDate, this.endDateInput = this.endCalendar.inputDate, this.dateRange = ko.observable([this.startDate().format('L'), this.endDate().format('L')]), this.startDate.subscribe(function (t) {
                return function (e) {
        ...
        return t.prototype.periodProxy = d, t.prototype.calendars = function () {
            ...
            return this.period(t), this.expanded(!0)
