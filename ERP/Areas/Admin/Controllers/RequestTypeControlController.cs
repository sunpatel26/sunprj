...
namespace ERP.Areas.Admin.Controllers
{
    ...
    public class RequestTypeControlController : SettingsController
    {
        ...
        public ActionResult Index(int id,[FromQuery(Name = "grid-page")] string gridpage = "1", [FromQuery(Name = "grid-column")] string orderby = "", [FromQuery(Name = "grid-dir")] string sortby = "0", [FromQuery(Name = "grid-filter")] string gridfilter = "", [FromQuery(Name = "grid-search")] string search = "")
        {
            try
            {
                int userid = USERID;
                IQueryCollection query = Request.Query;
                PagedDataTable<RequestTypeControlMetadata> pds = _requestTypeControl.GetList(id, COMPANYID, gridpage.ToInt(), PAGESIZE, orderby, sortby == "0" ? "ASC" : "DESC", search);
