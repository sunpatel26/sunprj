    ...
    public class RequestTypeControlScreenController : BaseController
    {
        ...
        public ActionResult Index(int id = 0)
        {
            ...
            try
            {
                ...
                List<RequestTypeControlScreenMappingMetadata> pds = _requestTypeControlScreenMapping.GetList(id);
                Action<IGridColumnCollection<RequestTypeControlScreenMappingMetadata>> columns = c =>
                {
                    ...
                    c.Add()
                        ...
                        .SetWidth(60)
                        .RenderValueAs(o =>
                           string.Format("<a href='{0}' class='btn'>Controls</a>", Url.Action("Index", "RequestTypeControl", new { id = o.RequestTypeControlScreenID,cid=id })) +
