...
namespace ERP.Areas.SuperAdmin.Controllers
{
    ...
    public class RequestTypeModuleController : SettingsController
    {
        ...
        public ActionResult Index(int id = 0,int cid=0)
        {
            ...
            try
            {
                ...
                List<RequestTypeTitleMetadata> pds= _requestTypeModule.GetList(id, cid);
                Action<IGridColumnCollection<RequestTypeTitleMetadata>> columns = c =>
                {
                    ...
                    c.Add()
                        ...
                        .SetWidth(60)
                        .RenderValueAs(o =>
                           string.Format("<a href='{0}' class='btn'>Controls</a>",Url.Action("Index","RequestTypeControl",new { id=o.RequestTypeTitleID,cid=cid })) +
