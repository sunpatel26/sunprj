...
namespace GridMvc.Html
{
    ...
    public class HtmlGrid<T> : GridHtmlOptions<T>, IGrid<T>
    {
        ...
        public GridSettings CommonSettings
        {
            get { return _source.CommonSettings; }
            set { _source.CommonSettings = value; }
        }
        ...
        {
            get { return _source.ControllerName; }
            set { _source.ControllerName = value; }
        }
        public string ActionName
        {
            get { return _source.ActionName; }
            set { _source.ActionName = value; }
        }

        public string PermissionCssClass
        {
            get { return _source.PermissionCssClass; }
            set { _source.PermissionCssClass = value; }
        }

        public string UploadControllerName
        {
            get { return _source.UploadControllerName; }
            set { _source.UploadControllerName = value; }
        }
        public string UploadActionName
        {
            get { return _source.UploadActionName; }
            set { _source.UploadActionName = value; }
        }
