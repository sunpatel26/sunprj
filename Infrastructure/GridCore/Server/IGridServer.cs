...
namespace GridCore.Server
{
    ...
    public interface IGridServer<T>
    {
        ...
        IGridServer<T> CommonSettings(GridSettings item);
        ...
        IGridServer<T> RouteAction(string controllerName,string actionName,string cssClass="");
        IGridServer<T> UploadAction(string controllerName, string actionName);
        /// <summary>
