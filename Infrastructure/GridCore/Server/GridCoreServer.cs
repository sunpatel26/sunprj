...

{
    ...
    public class GridCoreServer<T> : IGridServer<T>
    {
        ...
        public IGridServer<T> CommonSettings(GridSettings item)
        {
            _source.CommonSettings = item;
            return this;
        }
        ...
        public IGridServer<T> RouteAction(string controllerName,string actionName,string cssClass="")
        {
            _source.ControllerName = controllerName;
            _source.ActionName = actionName;
            _source.PermissionCssClass = cssClass;
            return this;
        }
        public IGridServer<T> UploadAction(string controllerName, string actionName)
        {
            _source.UploadControllerName = controllerName;
            _source.UploadActionName = actionName;
            return this;
        }
